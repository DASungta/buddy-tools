...
pub fn run() {
            ...
            match modules::config::load_app_config() {
                Ok(mut config) => {
                    ...
                    if let Err(e) = commands::proxy::internal_start_proxy_service(
                        config.proxy,
                        &proxy_state,
                        crate::modules::system_integration::SystemManager::Headless,
                        cf_state.clone(),
                    ).await {
    ...
    tauri::Builder::default()
        ...
        .setup(|app| {
            ...
            // Start CodeBuddy CN token keeper background task (if needed)
            ...
            tauri::async_runtime::spawn(async move {
                ...
                if let Ok(config) = modules::config::load_app_config() {
                    ...
                    let integration =
                        crate::modules::system_integration::SystemManager::Desktop(handle.clone());
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            // CodeBuddy CN account commands
            commands::codebuddy_cn::list_codebuddy_cn_accounts,
            commands::codebuddy_cn::list_codebuddy_cn_cached_models,
            ...
            commands::codebuddy_cn::set_current_codebuddy_cn_account,
            commands::codebuddy_cn::start_codebuddy_cn_oauth_login,
            commands::codebuddy_cn::complete_codebuddy_cn_oauth_login,
            commands::codebuddy_cn::cancel_codebuddy_cn_oauth_login,
            commands::codebuddy_cn::get_checkin_status_codebuddy_cn,
            commands::codebuddy_cn::checkin_codebuddy_cn,
            // CodeBuddy CN multi-instance commands
            commands::codebuddy_cn_instance::list_codebuddy_cn_instances,
            commands::codebuddy_cn_instance::get_codebuddy_cn_instance_defaults,
            commands::codebuddy_cn_instance::get_codebuddy_cn_default_settings,
            commands::codebuddy_cn_instance::create_codebuddy_cn_instance,
            commands::codebuddy_cn_instance::update_codebuddy_cn_instance,
            commands::codebuddy_cn_instance::delete_codebuddy_cn_instance,
            commands::codebuddy_cn_instance::start_codebuddy_cn_instance,
            commands::codebuddy_cn_instance::focus_codebuddy_cn_instance,
            commands::codebuddy_cn_instance::stop_codebuddy_cn_instance,
            commands::codebuddy_cn_instance::get_codebuddy_cn_instance_pid,
            commands::codebuddy_cn_instance::inject_token_for_codebuddy_cn_instance,
        ])
