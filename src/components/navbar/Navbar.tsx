import { Network, Settings, Lock, Bot, Layers } from 'lucide-react';
...
function Navbar() {
    ...
    const navItems: NavItem[] = [
        { path: '/', label: t('nav.codebuddy_cn', 'CodeBuddy CN'), icon: Bot, priority: 'high' },
        { path: '/api-proxy', label: t('nav.proxy'), icon: Network, priority: 'high' },
        { path: '/security', label: t('nav.security'), icon: Lock, priority: 'low' },
        { path: '/codebuddy-cn-instances', label: t('nav.codebuddy_cn_instances', 'CB CN 实例'), icon: Layers, priority: 'medium' },
