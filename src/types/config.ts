...
export interface ProxyConfig {
    ...
    zai?: ZaiConfig;
    codebuddy_cn?: CodeBuddyCnConfig;
...
export type CodeBuddyCnDispatchMode = 'off' | 'exclusive';

export interface CodeBuddyCnConfig {
    enabled: boolean;
    base_url: string;
    token: string;
    user_id: string;
    model: string;
    dispatch_mode: CodeBuddyCnDispatchMode;
